...
public class ComputerRedefineQuestions1 extends Activity  {
    private String id;
    ...
    public ComputerRedefineQuestions1(String id, String q, String oa, String ob, String oc, String od, String ans) {
...
//    }
    ...
    public ComputerRedefineQuestions1() {
        id = "";
        question = "";
        opta = "";
        optb = "";
